...
export default function UserLayout() {
  ...
  return (
    <Tabs screenOptions={{tabBarActiveBackgroundColor: '#000000', tabBarInactiveBackgroundColor: '#000000'}}>
        <Tabs.Screen name="home" options={{headerShown: false,tabBarShowLabel: false, tabBarIcon: () =>(<Image source={require("@/assets/images/home.png")} width={50} height={50}/>)}}></Tabs.Screen>
